...
<link rel="stylesheet" href="addcity.css" media="screen">
  ...
  <button style="margin-left:50px;margin-top:30px;" onclick="window.history.back();"class="u-btn u-btn-submit u-button-style u-hover-custom-color-2 u-palette-4-dark-2 u-btn-1">BACK</button>
      <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <div class="u-form u-form-1">
          <form action="addcenter1.php" method="POST" class="u-clearfix u-form-spacing-33 u-form-vertical u-inner-form" style="padding: 50px;" source="custom" name="form">
            ...
            <div class="u-align-center u-form-group u-form-submit">
              <a class="u-btn u-btn-submit u-button-style u-hover-custom-color-2 u-palette-4-dark-2 u-btn-1">Submit</a>
